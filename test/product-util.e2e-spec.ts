...
describe('parseVariantInputs', () => {
  it('parses valid variants with sku and stock', () => {
    const variants = parseVariantInputs([
      { sku: ' agn-1 ', weight: '1 кг.', price: 500.6, stock: 3.2, id: 'v1' },
      { sku: 'agn-2', weight: '2 кг.', price: 900, stock: 0 },
    ]);
  ...
  it('skips invalid rows (missing sku/weight, bad price/stock)', () => {
    const variants = parseVariantInputs([
      null,
      { weight: '1 кг.', price: 100, stock: 1 },
      { sku: 'OK-1', weight: '', price: 100, stock: 1 },
      { sku: 'OK-2', weight: '1 кг.', price: -1, stock: 1 },
      { sku: 'OK-3', weight: '1 кг.', price: 100, stock: -5 },
      { sku: 'OK-4', weight: '1 кг.', price: 100, stock: 2 },
    ]);
